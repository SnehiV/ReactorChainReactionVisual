...
/***/ function(module, exports, __webpack_require__) {
	...
	var Simulation = function () {
	  function Simulation(ctx) {
	    ...
	    this.steadyStateFPS = this.fpsAtSteadyState(this.neutronSpeed);
	    this.powerLevel = [];
	  }
	  ...
	  _createClass(Simulation, [{
	    ...
	    value: function checkMeltdown() {
	      ...
	      var avgPowerLevel = total / this.powerLevel.length;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Neutron = function () {
	  function Neutron(simulation, options) {
	    ...
	    this.speed = this.simulation.neutronSpeed;
	...
	var Core = function (_Neutron) {
	  ...
	  _createClass(Core, [{
	    ...
	    value: function getKValue(e) {
	      this.kValue = parseFloat(document.getElementById("kvalue").value);
