	    ...
	    value: function checkCollisions() {
	      ...
	      neutrons.forEach(function (neutron, idx) {
	        if (neutron.isCollidedWith(_this.core)) {
	          _this.core.color = 'red';
	          _this.removeNeutron(idx);
	          _this.neutrons.push(_this.core.generateNeutrons(neutron));
	          _this.core.color = 'white';
	        }
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Core = function (_Neutron) {
	  ...
	  function Core(simulation, options) {
	    ...
	    _this.color = "white";
	    _this.clearLength = _this.radius + 10;
	  ...
	  _createClass(Core, [{
	    ...
	    key: 'generateNeutrons',
	    value: function generateNeutrons(oldNeutron) {
	      ...
	      var newVel = _util2.default.randomWrapVelocity(side, oldNeutron.speed);
